...
// with the one present in the v0.32.1 client-go source[1] is
// the modification to change the maxAge variable to ~3 years.
//
// [1]: https://github.com/kubernetes/client-go/blob/9d43434511c4ed29af910f934efef2c123c80b49/util/cert/cert.go#L100-L222
